...
import { displayViewCertificates } from "../../../../redux/display";
...
const ViewCertificate = (props) => {
  ...
  const display = useSelector((state) => state.displays.openViewCertificates);
  ...
  const closeDialog = async () => {
    dispatch(displayViewCertificates("none"));
  };
