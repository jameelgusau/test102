...
import { displayDeleteUnit, displayEditUnit, displayReserve } from "../../../../redux/display";
    ...
    <div className="modal__content" ref={myRef}>
      ...
      <div className="model-body">
        <div className="edit-button">
          ...
          <div className="add-units"  onClick={()=> dispatch(displayDeleteUnit("block"))}>
            <IconContext.Provider
              value={{ className: "global-class-name" }}             
            >
              <div>
  ...
  unit &&(
    <>
        ...
        <div className="model-body__row">
          ...
          <h4 className="model-body__row--text">&#8358; {unit.price ? unit.price.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ","): "" }</h4>
        </div>
    </>
  )
}
