...
import { displayDeleteProperty } from "../../../../redux/display";
...
const DeleteProperty = (props) => {
  ...
  const closeDialog = () =>{
    dispatch(displayDeleteProperty("none"))
        ...
        <div className="modal__content" ref={myRef}>
          ...
          <form onSubmit={ deleteProperty }>
            <div className="property-input">
             <h3 className="align">Are you sure you want to delete unit {property.name}</h3>
